(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_HRM_leaveform_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    titleStack: function titleStack() {
      ...
      if (this.isProfileExists) {
        ...
        lastCrumb = 'New Leave Type';
      }
      return ['Admin', 'HRM', lastCrumb];
    },
  ...
  methods: {
    ...
    getData: function getData() {
      var _this = this;
      if (this.id) {
        axios.get("/leaves/".concat(this.id)).then(function (r) {
    ...
    leaves: function leaves() {
      var _this2 = this;
      axios.get("leaves/ltype").then(function (res) {
        console.log(res);
        _this2.leav = res.data;
      })["catch"](function (e) {
        console.log(e);
      });
    },
    employee: function employee() {
      var _this3 = this;
      axios.get("leaves/staff").then(function (res) {
        console.log(res);
        _this3.empployees = res.data;
      })["catch"](function (e) {
        console.log(e);
      });
    },
    submit: function submit() {
      ...
      this.isLoading = true;
      var method = 'post';
      var url = '/leaves/Store';
      if (this.id) {
        method = 'patch';
        url = "/leaves/".concat(this.id);
      }
      axios({
        method: method,
        url: url,
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c("div", [_c("hero-bar", [_vm._v("\n    " + _vm._s(_vm.heroTitle) + "\n    "), _c("router-link", {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.form, "emp_id", $$v);
      },
      expression: "form.emp_id"
    }
  }, _vm._l(_vm.empployees, function (emp, index) {
    return _c("option", {
      key: index,
      domProps: {
        value: emp
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.form, "l_type", $$v);
      },
      expression: "form.l_type"
    }
  }, _vm._l(_vm.leav, function (leave, index) {
    return _c("option", {
      key: index,
      domProps: {
        value: leave
    ...
    model: {
      value: _vm.form.d_from,
      callback: function callback($$v) {
        _vm.$set(_vm.form, "d_from", $$v);
      },
      expression: "form.d_from"
    }
  })], 1), _vm._v(" "), _c("b-field", {
    attrs: {
      label: "Return Date"
    ...
    model: {
      value: _vm.form.d_to,
      callback: function callback($$v) {
        _vm.$set(_vm.form, "d_to", $$v);
      },
      expression: "form.d_to"
    }
...
/***/ "./resources/js/views/HRM/leaveform.vue":
/*!**********************************************!*\
  !*** ./resources/js/views/HRM/leaveform.vue ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./leaveform.vue?vue&type=template&id=31db2b80& */ "./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80&");
/* harmony import */ var _leaveform_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./leaveform.vue?vue&type=script&lang=js& */ "./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _leaveform_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__.render,
  _leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/HRM/leaveform.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js&":
/*!***********************************************************************!*\
  !*** ./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_leaveform_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./leaveform.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_leaveform_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80&":
/*!*****************************************************************************!*\
  !*** ./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_leaveform_vue_vue_type_template_id_31db2b80___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./leaveform.vue?vue&type=template&id=31db2b80& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/HRM/leaveform.vue?vue&type=template&id=31db2b80&");
