(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Revenue_payvehicles_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      items: null,
      tax_id: null
    }, _defineProperty(_ref, "form", this.getClearFormObject()), _defineProperty(_ref, "createdReadable", null), _defineProperty(_ref, "expiredate", new Date()), _ref;
  },
  computed: {
  ...
  methods: {
    ...
    grade: function grade() {
      var _this = this;
      axios.get("shops/grade").then(function (res) {
        console.log(res);
        _this.grades = res.data;
      })["catch"](function (e) {
        console.log(e);
      });
    },
    getList: function getList() {
      var _this2 = this;
      if (this.id) {
        axios.get("/tax/".concat(this.id)).then(function (r) {
          _this2.form = r.data.data;
          _this2.items = lodash_clone__WEBPACK_IMPORTED_MODULE_0___default()(r.data.data);

          // this.form.expired = new Date(r.data.data.created_mm_dd_yyyy)
        })["catch"](function (e) {
          _this2.items = null;
    ...
    getData: function getData() {
      var _this3 = this;
      if (this.id) {
        axios.get("/shops/".concat(this.taxid)).then(function (r) {
    ...
    updateDate: function updateDate() {
      var _this4 = this;
      axios.pu("tax/update/" + this.taxid, this.form1).then(function (res) {
        console.log(res);
        _this4.isUpdateMode = true;
        _this4.taxid = "";
        _this4.list = _this4.list.map(function (row) {
          return row.taxid == res.data.taxid ? row = res.data : row;
        });
    ...
    submitData: function submitData() {
      var _this5 = this;
      this.submit();
      axios.post("tax/Store", this.form1).then(function (res) {
        console.log(res);
        _this5.list.push(res.data);
        // this.$router.push({name: 'shops.edit',params:
        //{taxid: r.data.data.taxid}})
        _this5.isUpdateMode = true;
        _this5.tax_id = res.data.id;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead&":
/*!********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("hero-bar", [_vm._v("\n    " + _vm._s(_vm.heroTitle) + "\n    "), _c("router-link", {
  ...
  }, [_vm._v("Taxid")]), _vm._v(" "), _c("b-input", {
    attrs: {
      type: "text",
      id: "name",
  ...
  }, [_vm._v("Location")]), _vm._v(" "), _c("b-input", {
    attrs: {
      type: "text",
      id: "location",
  ...
  }, [_vm._v("Manager")]), _vm._v(" "), _c("b-input", {
    attrs: {
      type: "text",
      id: "manager",
      placeholder: "manager",
  ...
  }, [_vm._v("Owner")]), _vm._v(" "), _c("b-input", {
    attrs: {
      type: "text",
      id: "ownar",
      placeholder: "owner",
    ...
    model: {
      value: _vm.form.ownar,
      callback: function callback($$v) {
        _vm.$set(_vm.form, "ownar", $$v);
      },
      expression: "form.ownar"
    }
  }), _vm._v(" "), _c("label", {
    attrs: {
      "for": "mno"
    }
  }, [_vm._v("Manager No")]), _vm._v(" "), _c("b-input", {
    attrs: {
      type: "number",
      id: "mno",
      min: "7",
  ...
  }, [_vm._v("Owner number")]), _vm._v(" "), _c("b-field", [_c("b-input", {
    attrs: {
  ...
  }, _vm._l(_vm.grades, function (department, index) {
    return _c("option", {
      key: index,
      domProps: {
        value: department
  ...
  }), 0)], 1), _vm._v(" "), _c("b-field", [_c("b-input", {
    attrs: {
      type: "textarea",
      maxlength: "100",
  ...
  }, [Date.now() > new Date(_vm.item.expired) ? _c("div", [_c("form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.submit.apply(null, arguments);
    ...
    model: {
      value: _vm.form.collector,
      callback: function callback($$v) {
        _vm.$set(_vm.form, "collector", $$v);
      },
      expression: "form.collector"
    }
  })], 1), _vm._v(" "), _c("b-field", {
    attrs: {
      label: "Tell"
    ...
    model: {
      value: _vm.form.recievedNo,
      callback: function callback($$v) {
        _vm.$set(_vm.form, "recievedNo", $$v);
      },
      expression: "form.recievedNo"
    }
  })], 1), _vm._v(" "), _c("b-field", {
    attrs: {
      label: "Amount"
  ...
  }, [_c("option", [_vm._v("EVC-PLUS")]), _vm._v(" "), _c("option", [_vm._v("E-DAHAB")]), _vm._v(" "), _c("option", [_vm._v("JEEB")]), _vm._v(" "), _c("option", [_vm._v("CASH")]), _vm._v(" "), _c("option", [_vm._v("CHEQUE")])])], 1), _vm._v(" "), _c("b-field", {
    attrs: {
      label: "Valid until"
    }
  }, [_c("b-input", {
  ...
  }, [_vm._v("\n          Update\n      ")])])], 1)]) : _vm._e(), _vm._v(" "), Date.now() < new Date(_vm.items.expired) ? _c("div", [_c("b-field", {
    attrs: {
      label: "Collector"
    }
  }, [_c("b-input", {
    attrs: {
      value: _vm.items.Collector,
      "custom-class": "is-static",
      readonly: ""
    }
  })], 1), _vm._v(" "), _c("b-field", {
    ...
    attrs: {
      value: _vm.items.expired,
      "custom-class": "is-static",
      readonly: ""
    }
  })], 1)], 1) : _vm._e()]) : _vm._e()], 1)], 1)], 1);
};
var staticRenderFns = [];
render._withStripped = true;
...
/***/ "./resources/js/views/Revenue/payvehicles.vue":
/*!****************************************************!*\
  !*** ./resources/js/views/Revenue/payvehicles.vue ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./payvehicles.vue?vue&type=template&id=7f0ecead& */ "./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead&");
/* harmony import */ var _payvehicles_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./payvehicles.vue?vue&type=script&lang=js& */ "./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _payvehicles_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__.render,
  _payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/Revenue/payvehicles.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js&":
/*!*****************************************************************************!*\
  !*** ./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_payvehicles_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./payvehicles.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_payvehicles_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead&":
/*!***********************************************************************************!*\
  !*** ./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead& ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_payvehicles_vue_vue_type_template_id_7f0ecead___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./payvehicles.vue?vue&type=template&id=7f0ecead& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Revenue/payvehicles.vue?vue&type=template&id=7f0ecead&");
