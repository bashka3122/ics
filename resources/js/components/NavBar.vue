      ...
      <div class="navbar-end">
        ...
        <nav-bar-menu class="has-divider has-user-avatar">
          ...
          <div slot="dropdown" class="navbar-dropdown">
            ...
            <router-link to="/district" class="navbar-item" exact-active-class="is-active">
        ...
        <a href="https://otech.so" class="navbar-item has-divider is-desktop-icon-only" title="About">
