<template>
    <div>
        <section class="section is-main-section">
            <tiles>
                <card-component title="Districts" icon="account-edit" class="tile is-child">
                ...
                <card-component class="has-table has-mobile-sort-spaced tile is-child" icon="account-multiple">
                    <card-toolbar>
                        <router-link slot="left" to="/district">
                    ...
                    <b-table :checked-rows.sync="checkedRows" :checkable="true" :loading="isLoading" :paginated="paginated"
                        ...
                        <b-table-column label="Region" field="note" sortable v-slot="props">
                            {{ props.row.region }}
                        </b-table-column>
                        ...
                        <b-table-column custom-key="actions" class="is-actions-cell" v-slot="props">
                            <div class="buttons is-right">
                                <router-link :to="{ name: 'district.edit', params: { id: props.row.id } }"
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.isLoading = true
            let method = 'post'
            let url = '/setting/district/Store'
